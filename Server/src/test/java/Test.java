...
public class Test {
    ...
    public static void main(String[] args){
        ...
        String pathUsers = path + "/Users.json";
        String pathMovies = path + "/Movies.json";

        //String pathUsers = "/home/amir/Desktop/Spl/Server-Client-master/spl-net/Movies.json";
      //  String pathMovies = "/home/amir/Desktop/Spl/Server-Client-master/spl-net/Users.json";
